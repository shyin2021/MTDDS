...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/2/nation.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/2/region.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/2/supplier.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/2/customer.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/2/part.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/2/partsupp.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/2/orders.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/2/lineitem.tbl")
;
