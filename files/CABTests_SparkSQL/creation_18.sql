...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/18/nation.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/18/region.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/18/supplier.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/18/customer.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/18/part.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/18/partsupp.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/18/orders.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/18/lineitem.tbl")
;
