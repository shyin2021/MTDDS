...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/3/nation.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/3/region.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/3/supplier.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/3/customer.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/3/part.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/3/partsupp.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/3/orders.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/3/lineitem.tbl")
;
