...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/5/nation.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/5/region.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/5/supplier.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/5/customer.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/5/part.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/5/partsupp.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/5/orders.tbl")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "file:///root/home/spark/mtdds/tpch/5/lineitem.tbl")
;
