...
public class MTTestsDriver_SUT4_tenant1 {
    private static final int MAX_AV = 3;
    private static final int NB_QUERIES = 26;
	...
	try{
		csvWriter = new FileWriter("/root/home/spark/mtdds/files_SparkSQL/step6Drivers_SparkSQL/ExecutionTraces_SUT4_tenant1_ARF" + arrivalRateFactor/10 +".csv"); // SUT4
