...
public class MTTestsDriver_SUT4_tenant5 {
    private static final int MAX_AV = 3;
    private static final int NB_QUERIES = 36;
	...
	TimerTask tt = new TimerTask(){
		public void run(){
			...
			do{        		
				...
				scriptFileName = "/root/home/spark/mtdds/files_SparkSQL/step5IndividualQueries/l/"+ queryNumber + ".sql";
	...
	try{
		csvWriter = new FileWriter("/root/home/spark/mtdds/files_SparkSQL/step6Drivers_SparkSQL/ExecutionTraces_SUT4_tenant5_ARF" + arrivalRateFactor/10 +".csv"); // SUT4
