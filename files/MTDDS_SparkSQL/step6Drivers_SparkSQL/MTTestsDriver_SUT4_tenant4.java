...
public class MTTestsDriver_SUT4_tenant4 {
    private static final int MAX_AV = 3;
    private static final int NB_QUERIES = 48;
	...
	TimerTask tt = new TimerTask(){
		public void run(){
			...
			do{        		
				...
				scriptFileName = "/root/home/spark/mtdds/files_SparkSQL/step5IndividualQueries/s/"+ queryNumber + ".sql";
	...
	try{
		csvWriter = new FileWriter("/root/home/spark/mtdds/files_SparkSQL/step6Drivers_SparkSQL/ExecutionTraces_SUT4_tenant4_ARF" + arrivalRateFactor/10 +".csv"); // SUT4
