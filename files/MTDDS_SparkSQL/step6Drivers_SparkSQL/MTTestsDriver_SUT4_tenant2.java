...
public class MTTestsDriver_SUT4_tenant2 {
    private static final int MAX_AV = 3;
    private static final int NB_QUERIES = 73;
	...
	try{
		csvWriter = new FileWriter("/root/home/spark/mtdds/files_SparkSQL/step6Drivers_SparkSQL/ExecutionTraces_SUT4_tenant2_ARF" + arrivalRateFactor/10 +".csv"); // SUT4
