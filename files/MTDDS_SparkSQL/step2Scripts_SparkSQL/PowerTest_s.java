...
public class PowerTest_s {
    private static FileWriter csvWriter = null;

    public static void main(String[] args) {

			try {
				csvWriter = new FileWriter("/root/home/spark/mtdds/files_SparkSQL/step2Scripts_SparkSQL/ExecTime_1.csv");
		...
		String scriptFileName = "/root/home/spark/mtdds/files_SparkSQL/step5IndividualQueries/s/" + queryNumber + ".sql";
