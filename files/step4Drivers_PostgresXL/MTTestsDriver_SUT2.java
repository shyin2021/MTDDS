...
public class MTTestsDriver_SUT2 {
    private static final int MAX_AV = 3;
    private static final int MAX_NB_LRQ = 1; // maximum number of concurrent long running queries
    private static final int NB_QUERIES = 290;
    private static final List<Integer> LongRunningQueries = Arrays.asList(22, 28, 37, 55, 97); // execution time > 5 minutes
    private static Semaphore sem = new Semaphore(MAX_AV, true);
    private static Semaphore sem_lrq = new Semaphore(MAX_NB_LRQ, true); // V2
	...
	TimerTask tt = new TimerTask(){
		public void run(){
			...
			try{
				if(LongRunningQueries.contains(queryNumber)){ // V2
					sem_lrq.acquire();
				}
			...
			do{        		
				...
				if(DBSize.equals("Small")){
					scriptFileName = "/root/home/postgres/mtdds/files/step5IndividualQueries/s/" 
								+ queryNumber + ".sql";
				}
				else if(DBSize.equals("Medium")){
					scriptFileName = "/root/home/postgres/mtdds/files/step5IndividualQueries/m/" 
								+ queryNumber + ".sql";
				} else // if(DBSize.equals("Large"))
				{
					scriptFileName = "/root/home/postgres/mtdds/files/step5IndividualQueries/l/" 
								+ queryNumber + ".sql";
				}
	...
	try{
		...
		while(line != null){
			...
			createTimerTask((arrivalTime * 600000+(int)(arrivalTimeDigits*600000))/arrivalRateFactor, queryNumber, source, DBSize);
			line = br.readLine();	
		}	
	}
	catch(FileNotFoundException fnd){
	...
	try{
		csvWriter = new FileWriter("ExecutionTraces_SUT2_ARF" + arrivalRateFactor +".csv"); // SUT2
	...
	source1.setServerName("172.16.66.12:20004");
	source1.setDatabaseName("tenant1");
	source1.setUser("tenant1");
	source1.setPassword("tenant1");
	source1.setMaxConnections(100);
	String fileName1 = "/root/home/postgres/mtdds/files/6tenantsQueries/Tenant_1_Queries.csv";
	...
	source2.setServerName("172.16.66.12:20004");
	source2.setDatabaseName("tenant2");
	source2.setUser("tenant2");
	source2.setPassword("tenant2");
	source2.setMaxConnections(100);
	String fileName2 = "/root/home/postgres/mtdds/files/6tenantsQueries/Tenant_2_Queries.csv";
	...
	source3.setServerName("172.16.66.12:20004");
	source3.setDatabaseName("tenant3");
	source3.setUser("tenant3");
	source3.setPassword("tenant3");
	source3.setMaxConnections(100);
	String fileName3 = "/root/home/postgres/mtdds/files/6tenantsQueries/Tenant_3_Queries.csv";
	...
	source4.setServerName("172.16.66.12:20004");
	source4.setDatabaseName("tenant4");
	source4.setUser("tenant4");
	source4.setPassword("tenant4");
	source4.setMaxConnections(100);
	String fileName4 = "/root/home/postgres/mtdds/files/6tenantsQueries/Tenant_4_Queries.csv";
	...
	source5.setServerName("172.16.66.12:20004");
	source5.setDatabaseName("tenant5");
	source5.setUser("tenant5");
	source5.setPassword("tenant5");
	source5.setMaxConnections(100);
	String fileName5 = "/root/home/postgres/mtdds/files/6tenantsQueries/Tenant_5_Queries.csv";
	...
	source6.setServerName("172.16.66.12:20004");
	source6.setDatabaseName("tenant6");
	source6.setUser("tenant6");
	source6.setPassword("tenant6");
	source6.setMaxConnections(100);
	String fileName6 = "/root/home/postgres/mtdds/files/6tenantsQueries/Tenant_6_Queries.csv";
